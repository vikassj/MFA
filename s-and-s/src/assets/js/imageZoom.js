  ...
  return function () {
    ...
    1: [function (require, module, exports) {
      ...
      function createPanZoom(domElement, options) {
        ...
        var maxZoom = typeof options.maxZoom === 'number' ? options.maxZoom : 12
        ...
        function getPositions(e) {
          ...
          mouseX = (offset.x - transform.x) / transform.scale;
          mouseY = (offset.y - transform.y) / transform.scale;
